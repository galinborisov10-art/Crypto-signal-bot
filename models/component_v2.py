"""
🧩 COMPONENT V2 - ICT Component Data Model
Defines the ComponentV2 dataclass used by the V2 detectors and engines.
...
class ComponentV2:
    ...
    def overlaps_with(self, other: "ComponentV2") -> bool:
